...
/* XXX
 * There are two init functions for antenna selection...
...
r23b_init_antsel(struct rtwn_softc *sc)
{
	...
	/* XXX This is the other function. */
	rtwn_setbits_1(sc, R92C_LEDCFG2, 0, 1 << 7);
}
...
r23b_post_init(struct rtwn_softc *sc)
{
	...
	//rtwn_setbits_1(sc, R92C_BCN_CTRL(0), 0, R92C_BCN_CTRL_EN_BCN);
	...
	/* XXX no idea */
	//rtwn_setbits_4(sc, R92C_OFDM0_AGCCORE1(0), 0x7f, 0x1e);
